...
class Beziehung(models.Model):
    f41x = models.OneToOneField('Person', models.DO_NOTHING, db_column='F41X', primary_key=True)  # Field name made lowercase.
    art = models.IntegerField(db_column='Art')  # Field name made lowercase.
    f41y = models.ForeignKey('Person', models.DO_NOTHING, db_column='F41Y')  # Field name made lowercase.
...
class Person(models.Model):
    ...
    f15 = models.ForeignKey(Ort, models.DO_NOTHING, db_column='F15')  # Field name made lowercase.
    ...
    f17 = models.ForeignKey(Ort, models.DO_NOTHING, db_column='F17', blank=True, null=True)  # Field name made lowercase.
